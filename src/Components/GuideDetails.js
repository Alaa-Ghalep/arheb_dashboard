...
export default function GuideDetails() {
  return (
    <div>
          ...
          <h3 className='mb-4'  style={{fontWeight:'bold'}}> المرشدين السياحين/ تفاصيل الفندق </h3>
            ...
            <div className='row g-4'>
                ...
                <div className='col-md-6 col-lg-3 col-xl-3'>
                    <div className='d-flex py-3' style={{borderRadius:20,justifyContent:'space-around'}}>
                        <h5 className='mt-2 ' style={{marginRight:1,fontWeight:'bold'}}> رقم المرشد :</h5>
            ...
            <div className='row mt-lg-4  g-4'>
               ...
               <div className='col-md-6 col-lg-4 col-xl-4'>
                <div>
                    <img className='img-fluid w-75' src={guide}/>
                    </div>
                    </div> 
             ...
             <div className='row mt-5'>
                <div className='col-lg-4'></div>
                    <img className='img-fluid w-50' src={map2}/>
